...
- api_fingerprint            (See section #1)
- api_private_key_path       (See section #1)
- api_private_key_password   (See section #1) 
- compartment_id             (use the Tenancy OCID as per section #1) Note: using the Tenancy OCID selects the root compartment in that tenancy.
- tenancy_id                 (See section #1)          
- user_id                    (See section #1)
...
14. Enter the SSH public key. (See section #3)
...
- Login with weblogic username (weblogic) and the **plain text password** you selected in section #2
